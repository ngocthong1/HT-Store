...
const Explore = () => {
  ...
  return (
    <section className="relative">
      <div
        className="absolute inset-0 bg-lightColor-300 pointer-events-none mb-16"
        aria-hidden="true"
      ></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4 text-black !font-bold">
              ...
              <div className="mb-8 md:mb-0">
                <a
                  className={`flex items-center text-lg p-5 rounded border-4 transition duration-300 ease-in-out mb-3 ${
                    tab !== 1
                      ? 'bg-lightColor-300 shadow-md border-lightColor-100 hover:shadow-lg'
                      : 'bg-grayshade-200 text-white border-purpleshade-400'
                  }`}
                  href="#0"
                  onClick={(e) => {
                    e.preventDefault();
                ...
                >
                  ...
                  <div className="flex justify-center items-center w-8 h-8 bg-lightColor-300 rounded-full shadow flex-shrink-0 ml-3">
                    <FaBoltLightning className="text-grayshade-500" />
                  </div>
                </a>
                <a
                  className={`flex items-center text-lg p-5 rounded border-4 transition duration-300 ease-in-out mb-3 ${
                ...
                >
                  ...
                  <div className="flex justify-center items-center w-8 h-8 bg-lightColor-300 rounded-full shadow flex-shrink-0 ml-3">
                    <IoPaperPlane className="text-grayshade-500" />
                  </div>
                </a>
                <a
                  className={`flex items-center text-lg p-5 rounded border-4 transition duration-300 ease-in-out mb-3 ${
                ...
                >
                  ...
                  <div className="flex justify-center items-center w-8 h-8 bg-lightColor-300 rounded-full shadow flex-shrink-0 ml-3">
                    <BiSolidMoon className="text-grayshade-500" />
                  </div>
                </a>
              </div>
            </div>
