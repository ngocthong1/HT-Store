const FeaturesBlock = () => {
  return (
    <section className="relative">
      ...
      <div
        className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-grayshade-400 pointer-events-none"
        aria-hidden="true"
      ></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-black font-bold">How Simple works</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-lightColor-300 rounded shadow-xl">
              <svg
              ...
              >
                <g fill="none" fillRule="evenodd">
                  <rect
                    className="fill-current text-purpleshade-400"
                    width="64"
                    height="64"
                    rx="32"
                  />
              ...
              <p className="text-grayshade-50 text-center">
