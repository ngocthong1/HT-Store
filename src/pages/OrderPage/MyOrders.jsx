          ...
          >
            <ul>
              {order.OrderItems.map((item, key) => (
                <li
                  key={key}
                  className="p-1 xl:p-2 text-sm lg:text-xl grid grid-cols-4 gap-4 border-b border-b-grayshade-50 dark:border-b-grayshade-300 items-center"
                >
                  <img
